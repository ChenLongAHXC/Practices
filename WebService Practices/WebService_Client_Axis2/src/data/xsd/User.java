...
public class User implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://data/xsd Namespace Prefix = ns1
	 */
	...
	private static java.lang.String generatePrefix(java.lang.String namespace) {
		if (namespace.equals("http://data/xsd")) {
			return "ns1";
		}
						...
						if (!"User".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (User) org.apache.ws.axis2.ExtensionMapper
	...
	public String toString() {
		return "User [localAddress=" + localAddress + ", localEmail="
				+ localEmail + ", localId=" + localId + ", localName="
				+ localName + "]";
	}
