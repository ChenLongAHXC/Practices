 ...
 * 2014-03-07T14:31:19.544+08:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://localhost:9009/hw?WSDL",
                  targetNamespace = "http://service.test/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.test/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://service.test/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9009/hw?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9009/hw?WSDL");
        }
        WSDL_LOCATION = url;
    }
